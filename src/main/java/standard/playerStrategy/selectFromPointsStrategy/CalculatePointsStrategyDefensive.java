...
public class CalculatePointsStrategyDefensive implements CalculatePointsStrategy {
    @Override
    public int CalculatePoints(int row, int col, Board board) {
        ...
        if (row == col) {
            System.out.print("--Diag Right--");
            System.out.print("enemy unit in diag: " + diagREnemy);
        ...
        if (col == (BOARD_SIZE - 1 - row)) {
            System.out.print("--Diag Left--");
            System.out.print("enemy units in diag: " + diagLEnemy);
